...
@Component({
  selector: 'app-submission-form4',
  templateUrl: './submission-form4.component.html',
  styleUrls: ['./submission-form4.component.scss']
})
export class SubmissionForm4Component implements OnInit {
